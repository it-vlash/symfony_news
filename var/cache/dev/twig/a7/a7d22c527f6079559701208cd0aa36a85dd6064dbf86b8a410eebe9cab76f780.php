...
class __TwigTemplate_f588fdfc64442d18de4e3288ee71cf6e6636a314dd7da9df9850fd7f262ca20d extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<?php echo \$view['form']->block(\$form, 'form_widget_simple', ['type' => isset(\$type) ? \$type : 'text']).\$view->escape(\$symbol) ?>
", "@Framework/Form/percent_widget.html.php", "/var/www/new/vendor/symfony/framework-bundle/Resources/views/Form/percent_widget.html.php");
    }
}
